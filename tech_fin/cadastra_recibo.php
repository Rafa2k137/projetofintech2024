...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO recibo (id_usuario, nota_fiscal, dt_emissao, cpf_cliente, cnpj_cliente, quantidade, vl_unitario, vl_total)
    VALUES ('$id_usuario', '$nota_fiscal', '$dt_emissao', '$cpf_cliente', '$cnpj_cliente', '$quantidade', '$vl_unitario', '$vl_total')";

    if ($conn->query($sql) === TRUE) {
        // Mensagem de sucesso armazenada na sessão
        $_SESSION['mensagem'] = "<div id='mensagem' class='alert alert-success'>Recibo cadastrado com sucesso!</div>";
        ...
        $_SESSION['mensagem'] = "<div id='mensagem' class='alert alert-danger'>Erro ao cadastrar recibo: " . $conn->error . "</div>";
    }
    ...
    <div class="container mt-4">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="cpf_cliente" name="cpf_cliente" value="<?php echo $cpf_cliente; ?>" required>
                <div id="cpf_error_message" class="text-danger" style="display: none;">CPF inválido</div>
            </div>
            <div class="mb-3">
                <label for="cnpj_cliente" class="form-label">CNPJ do Cliente</label>
                <input type="text" class="form-control" id="cnpj_cliente" name="cnpj_cliente" value="<?php echo $cnpj_cliente; ?>" required>
            ...
            <div class="mt-3 text-center">
             <a href="consulta_recibo.php">Consultar Recibos</a>
         </div>
     </form>
 </div>
