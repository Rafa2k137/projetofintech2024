...
if (isset($_POST['delete'])) {
    if (isset($_POST['ids']) && !empty($_POST['ids'])) {
        ...
        $deleteQuery = "DELETE FROM RECIBO WHERE id_recibo IN ($ids)";
...
$query_total = "SELECT COUNT(*) FROM RECIBO";
...
// Consultar os registros da tabela RECIBO com limite e offset
$query = "SELECT * FROM RECIBO LIMIT :inicio, :registros_por_pagina";
...
<div class="container mt-5">
    <h2 class="text-center">Recibos</h2>
    <br>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php foreach ($recibos as $recibo): ?>
                    <tr>
                        <td><input type="checkbox" name="ids[]" value="<?php echo $recibo['id_recibo']; ?>"></td>
                        <td><?php echo htmlspecialchars($recibo['id_recibo']); ?></td>
                        <td><?php echo htmlspecialchars($recibo['nota_fiscal']); ?></td>
                        <td><?php echo htmlspecialchars($recibo['dt_emissao']); ?></td>
                        <td><?php echo htmlspecialchars($recibo['cpf_cliente']); ?></td>
                        <td><?php echo htmlspecialchars($recibo['cnpj_cliente']); ?></td>
                        <td><?php echo htmlspecialchars($recibo['quantidade']); ?></td>
                        <td><?php echo 'R$ ' . number_format($recibo['vl_unitario'], 2, ',', '.'); ?></td>
                        <td><?php echo 'R$ ' . number_format($recibo['vl_total'], 2, ',', '.'); ?></td>
                        <td><?php echo htmlspecialchars($recibo['data_cadastro']); ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
    ...
    <div class="mt-3 text-center">
        <a href="cadastra_recibo.php">Incluir Recibos</a>
    </div>
</div>
