...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-4">
            <a href="cadastra_recibo.php" class="btn btn-success btn-lg btn-block">Incluir Recibos</a>
        </div>
        <div class="col-md-4">
            <a href="consulta_recibo.php" class="btn btn-primary btn-lg btn-block">Consultar Recibos</a>
        </div>
    </div>
</div>
